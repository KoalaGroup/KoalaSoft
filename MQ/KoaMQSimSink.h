...
#ifndef KOAMQSIMSINK_H_
#define KOAMQSIMSINK_H_
...
class KoaMQSimDevice;

class KoaMQSimSink : public FairSink
{
 public:
    KoaMQSimSink();
    virtual ~KoaMQSimSink();
    ...
    virtual void        SetMQSimDevice(KoaMQSimDevice* mrs) { fMQSimDevice = mrs;}

 private: 
    KoaMQSimDevice* fMQSimDevice;
    
    KoaMQSimSink(const KoaMQSimSink&);
    KoaMQSimSink& operator=(const KoaMQSimSink&);
};

#endif /* KOAMQSIMSINK_H_ */
