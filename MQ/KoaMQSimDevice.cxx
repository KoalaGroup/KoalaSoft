...
void KoaMQSimDevice::PreRun()
{
}

bool KoaMQSimDevice::ConditionalRun()
{
    if ( fSimDeviceId == 0 )
...
void KoaMQSimDevice::UpdateParameterServer()
{
  FairRuntimeDb* rtdb = fRunSim->GetRuntimeDb();
  
  printf("KoaMQSimDevice::UpdateParameterServer() (%d containers)\n",rtdb->getListOfContainers()->GetEntries());
  ...
  printf("KoaMQSimDevice::UpdateParameterServer() finished\n");
}

void KoaMQSimDevice::SendObject(TObject* obj, std::string chan) {
...
void  KoaMQSimDevice::SendBranches()
{
  /// Fill the Root tree.
  LOG(DEBUG) << "called KoaMQSimDevice::SendBranches()!!!!";
