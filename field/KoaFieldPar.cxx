...
// ------   Constructor   --------------------------------------------------
KoaFieldPar::KoaFieldPar(const char* name, const char* title,
			 const char* context) 
...
// ------   Put parameters   -----------------------------------------------
void KoaFieldPar::putParams(FairParamList* list) {
...
// --------   Get parameters   ---------------------------------------------
Bool_t KoaFieldPar::getParams(FairParamList* list) {
...
void KoaFieldPar::SetParameters(FairField* field) {

  if ( ! field ) {
    cerr << "-W- KoaFieldPar::SetParameters: Empty field pointer!" << endl;
    return;
  }
  ...
  if ( fType == 0 ) {                                 // constant field
    KoaConstField* fieldConst = (KoaConstField*) field;
    ...
    cerr << "-W- KoaFieldPar::SetParameters: Unknown field type "
	 << fType << "!" << endl;
    fBx = fBy = fBz = 0.;
