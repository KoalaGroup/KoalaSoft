...
// -------------------------------------------------------------------------
// -----                    KoaFieldPar header file                  -----
// -----                Created 26/03/14  by M. Al-Turany              -----
// -------------------------------------------------------------------------



#ifndef KoaFieldPar_H
#define KoaFieldPar_H 1
...
class KoaFieldPar : public FairParGenericSet
{
 ...
 public:
  ...
  KoaFieldPar(const char* name, const char* title, const char* context);
...
/** default constructor  **/
 ...
 private:
  ...
  KoaFieldPar(const KoaFieldPar&);
  KoaFieldPar& operator=(const KoaFieldPar&);

  ClassDef(KoaFieldPar,1);
