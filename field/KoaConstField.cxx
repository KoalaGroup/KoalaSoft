...
KoaConstField::KoaConstField(const char* name, Double_t xMin, 
...
KoaConstField::KoaConstField(KoaFieldPar* fieldPar)
  : FairField(),
    fXmin(0.),   
    fXmax(0.),
    fYmin(0.),
...
{
  if ( ! fieldPar ) {
    cerr << "-W- KoaConstField::KoaConstField: empty parameter container!"
	 << endl;
    fType=0;
  }
  else {
...
// -----   Set field region   ----------------------------------------------
void KoaConstField::SetFieldRegion(Double_t xMin, Double_t xMax, 
...
// -----   Set field values   ----------------------------------------------
void KoaConstField::SetField(Double_t bX, Double_t bY, Double_t bZ) {
  fBx   = bX;
  fBy   = bY;
  fBz   = bZ;
}
...
Double_t KoaConstField::GetBx(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
...
Double_t KoaConstField::GetBy(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
       z < fZmin  ||  z > fZmax ) return 0.;
  return fBy;
...
Double_t KoaConstField::GetBz(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
       z < fZmin  ||  z > fZmax ) return 0.;
  return fBz;
...
// -----   Screen output   -------------------------------------------------
void KoaConstField::Print(Option_t* option) {
  cout << "======================================================" << endl;
