...
#ifndef KoaConstField_H
#define KoaConstField_H 1
...
class KoaConstField : public FairField
{
 ...
 public:    
   ...
   **/
  KoaConstField(const char* name, Double_t xMin, Double_t xMax,
		Double_t yMin, Double_t yMax, Double_t zMin,
		Double_t zMax, Double_t bX, Double_t bY, Double_t bZ);


  /** Constructor from KoaFieldPar **/
  KoaConstField(KoaFieldPar* fieldPar);


  /** Destructor **/
  virtual ~KoaConstField();
