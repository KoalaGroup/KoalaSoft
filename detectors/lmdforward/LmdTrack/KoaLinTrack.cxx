...
// -----   Default constructor   -------------------------------------------
KoaLinTrack::KoaLinTrack() {
  // std::cout<<"/lmd/LmdTrack/KoaLinTrack()"<<std::endl;
  // fCovMatrix = new TMatrixDSym(6);
}
// -------------------------------------------------------------------------

// -----   Standard constructor   ------------------------------------------
KoaLinTrack::KoaLinTrack(TString detName, Double_t p0, Double_t p1, Double_t p2,
...
void KoaLinTrack::GetParErr(Double_t* errpar) {
