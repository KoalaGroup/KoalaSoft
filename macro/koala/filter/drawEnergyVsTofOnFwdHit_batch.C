#include "drawEnergyVsTofOnFwdHit.C"

void drawEnergyVsTofOnFwdHit_batch(const char* indir, const char* suffix = "_calib.root")
{
  TString filelist [] ={
  ...
  for (int i=0;i<16;i++) {
    ...
    drawEnergyVsTofOnFwdHit(infile.Data(), suffix);
  }
