#include "drawRecAdcOnFwdHitAndTimeValid.C"

void drawRecAdcOnFwdHitAndTimeValid_batch(const char* indir, const char* suffix = ".root")
{
  TString filelist [] ={
  ...
  for (int i=0;i<16;i++) {
    ...
    drawRecAdcOnFwdHitAndTimeValid(infile.Data(), suffix);
  }
