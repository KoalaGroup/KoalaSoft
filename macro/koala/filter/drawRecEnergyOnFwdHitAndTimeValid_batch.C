#include "drawRecEnergyOnFwdHitAndTimeValid.C"

void drawRecEnergyOnFwdHitAndTimeValid_batch(const char* indir, const char* suffix = "_calib.root")
{
  TString filelist [] ={
  ...
  for (int i=0;i<16;i++) {
    ...
    drawRecEnergyOnFwdHitAndTimeValid(infile.Data(), suffix);
  }
