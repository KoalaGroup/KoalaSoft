#include "drawEnergyVsTimeOnFwdHit.C"

void drawEnergyVsTimeOnFwdHit_batch(const char* indir, const char* suffix = "_calib.root")
{
  TString filelist [] ={
  ...
  for (int i=0;i<16;i++) {
    ...
    drawEnergyVsTimeOnFwdHit(infile.Data(), suffix);
  }
