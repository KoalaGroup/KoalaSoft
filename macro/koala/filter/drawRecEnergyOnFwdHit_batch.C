#include "drawRecEnergyOnFwdHit.C"

void drawRecEnergyOnFwdHit_batch(const char* indir, const char* suffix = "_calib.root")
{
  TString filelist [] ={
  ...
  for (int i=0;i<16;i++) {
    ...
    drawRecEnergyOnFwdHit(infile.Data(), suffix);
  }
