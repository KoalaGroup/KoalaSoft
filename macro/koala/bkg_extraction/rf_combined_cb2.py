...
macro = os.path.join(macro_dir, 'rf_combined_cb2.C')
...
parser.add_argument("--channel_config",
                    default="rf_combined_cb2_config.txt",
...
f_channel_config = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitCombinedCB2_Channels.txt'))
f_strip_config = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitCombinedCB2_Strips.txt'))
...
dir_output = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitCombinedCB2'))
