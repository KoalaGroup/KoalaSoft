...
macro = os.path.join(macro_dir, 'rf_expo_cb2_ge1ge2.C')
...
parser.add_argument("--channel_config",
                    default="rf_expo_cb2_config_ge1ge2.txt",
...
f_channel_config = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitExpoCB2_Channels.txt'))
f_strip_config = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitExpoCB2_Strips.txt'))
