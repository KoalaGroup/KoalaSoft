...
macro = os.path.join(macro_dir, 'rf_coulomb_histpdf_cb2.C')
...
parser.add_argument("--config",
                    default="rf_coulomb_histpdf_cb2_config.txt",
...
f_config = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitHistPdfCoulombCB2.txt'))
it_nr = args.iterate_nr

## create directory to contain the text results from each iteration
dir_output = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitHistPdfCoulombCB2'))
