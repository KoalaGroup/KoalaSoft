...
macro = os.path.join(macro_dir, 'rf_nobkg_cb2_batch.C')
...
f_config = os.path.expanduser(args.infile.replace('.root', f'_{args.directory}_FitOnlyCB2.txt'))
