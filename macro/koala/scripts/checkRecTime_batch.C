#include "checkRecDigiTime.C"

void checkSingleRecDigiTime_batch(const char* indir, const char* sensor, int id)
{
  TString filelist [] ={
  ...
  for (int i=0;i<16;i++) {
    ...
    checkSingleRecDigiTime(infile.Data(),"koalasim",sensor,id);
  }
