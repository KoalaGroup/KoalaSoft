 ...
 * 3. noise_elist
 */
void identifyEvent(const char* filename = "~/workspace/data/calibrated/yong/P_3.0_2019_Aug_30_01_48_39_calib_yong_cluster.root", // root file containing tree 'KoalaClusterEvent'
