...
void select_TofE_withTF1(const char* filename,
                         double p0 = 450, double p1 = 79.3, double p2 = -0.9,
                         double win_low = -20, double win_high = 20,
                         ...
                         )
{
  ...
  for(int x=1;x<xbins+1;x++){
    ...
    auto tof_low = tof_calc + win_low;
    auto tof_high = tof_calc + win_high;
