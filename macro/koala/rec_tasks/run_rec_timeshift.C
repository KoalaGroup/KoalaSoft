 ...
 ********************************************************************************/
void run_rec_timeshift(const char* data, const char* tdcpara_file = "tdc_calib_shift.txt")
{
  // ----    Debug option   -------------------------------------------------
  gDebug = 0;
  ...
  paraFile.ReplaceAll("_calib_energy.root","_param.root");

  // Output file
  TString outFile(data);
  outFile.ReplaceAll("_calib_energy.root","_calib_timeshift.root");
