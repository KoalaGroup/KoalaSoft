...
#define R__DICTIONARY_FILENAME dIhomedIyongdIsrcdIKoalaSoftdIbuild_digidIdatadIG__KoaDataDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::KoaStack*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("KoaStack", ::KoaStack::Class_Version(), "", 57,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::KoaMCTrack*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("KoaMCTrack", ::KoaMCTrack::Class_Version(), "", 306,
...
"/home/yong/fairsoft/jun19/include/root6",
"/home/yong/src/KoalaSoft/build_digi/data/",
0
    };
...
inline Double_t KoaMCTrack::GetEnergy() const
{
...
inline void KoaMCTrack::GetMomentum(TVector3& momentum)
{
  momentum.SetXYZ(fPx,fPy,fPz);
}


inline void KoaMCTrack::Get4Momentum(TLorentzVector& momentum)
{
  momentum.SetXYZT(fPx,fPy,fPz,GetEnergy());
}


inline void KoaMCTrack::GetStartVertex(TVector3& vertex)
{
