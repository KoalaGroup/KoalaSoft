...
KoaMCTrack::KoaMCTrack(Int_t pdgCode, Int_t motherId, Double_t px,
...
Int_t KoaMCTrack::GetNPoints(DetectorId detId) const
{
...
void KoaMCTrack::SetNPoints(Int_t iDet, Int_t nPoints)
{
/*
  if ( iDet == kREF ) {
